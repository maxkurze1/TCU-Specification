...
\begin{register}{H}{\texttt{FEATURES}}{0xF000\_0000}
  \regfield{version\_patch}{8}{56}{?}%
  \regfield{version\_minor}{8}{48}{?}%
  \regfield{version\_major}{16}{32}{?}%
  ...
  \begin{regdesc}\begin{reglist}
    \item[version\_major] the TCU major version number
    \item[version\_minor] the TCU minor version number
    \item[version\_patch] the TCU patch version number
