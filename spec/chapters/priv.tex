...
With virtual memory support, the TCU maintains a TLB to cache recent address translations. The TLB
contains a 20-bit virtual page number (virtual address shifted right by 12 bits), 16-bit VPE id,
20-bit physical page number (physical address shifted right by 12 bits), and 5 bits for permissions.
Small pages are 4~KiB and large pages 2~MiB. The virtual and physical address are always page-size
aligned. The permissions are defined as follows:
