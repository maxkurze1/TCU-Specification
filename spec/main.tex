...
\section{Unprivileged Interface}
...
\subsubsection{\texttt{SET\_TIMER}}
...
\subsubsection{\texttt{ABORT\_CMD}}
...
The external interface of the TCU allows remote PEs to manipulate its state. For that purpose, the
TCU supports \emph{external commands}, which are triggered by writing to the \texttt{EXT\_CMD}
