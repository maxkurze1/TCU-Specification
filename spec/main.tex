...
\begin{scaletikzpicturetowidth}{0.98\linewidth}
  ...
  \path[undef] (0,0) rectangle (13,3) node[midway] {};
  \path[reg] (13,0) rectangle (19,3) node[midway] {rpos};
  \path[reg] (19,0) rectangle (25,3) node[midway] {wpos};
  \path[reg] (25,0) rectangle (31,3) node[midway] {slot\_size};
  \path[reg] (31,0) rectangle (37,3) node[midway] {slots};
  \path[reg] (37,0) rectangle (45,3) node[midway] {rpl\_eps};
  \path[undef] (45,0) rectangle (61,3) node[midway] {};
  \path[reg] (61,0) rectangle (64,3) node[midway] {T};
